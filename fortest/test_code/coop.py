    ...
    for kk in range(1, 7):
        ...
        for y in range(0, dimension[1] - 1000, 1000):
            ...
            for x in range(0, dimension[0] - 1000, 1000):
                ...
                print (
                he_result_iter[0][len(he_result_iter[0]) - 1][len(he_result_iter[0][len(he_result_iter[0]) - 1]) - 1],
                he_result_iter[1][len(he_result_iter[1]) - 1][len(he_result_iter[1][len(he_result_iter[1]) - 1]) - 1])
